...
RUN chmod +x /docker-entrypoint && \
    ...
    apk add --no-cache --update git nginx apache2-utils sudo bash supervisor py3-pip py3-setuptools bzip2 libpng libjpeg-turbo libwebp freetype gettext libzip openldap libmemcached icu libxml2 cyrus-sasl imap-dev mysql-client && \
